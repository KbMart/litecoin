...
"""Verify that starting panda3 with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start panda3 with -h for help text")
        ...
        self.log.info("Start panda3 with -version for version information")
        ...
        self.log.info("Start panda3d with -fakearg to make sure it does not start")
