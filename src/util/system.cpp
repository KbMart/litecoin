...
const char * const BITCOIN_CONF_FILENAME = "panda3.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Panda3";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Panda3";
#else
    // Unix
    return pathRet / ".panda3";
#endif
#endif
}
