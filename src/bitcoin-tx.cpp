...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " panda3-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  panda3-tx [options] <hex-tx> [commands]  Update hex-encoded panda3 transaction\n" +
            "or:     panda3-tx [options] -create [commands]   Create hex-encoded panda3 transaction\n" +
            "\n";
