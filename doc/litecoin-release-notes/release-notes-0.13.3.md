Panda3 Core version 0.13.3 is now available from:

  <https://download.panda3.org/panda3-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/panda3-project/panda3/blob/0.13/src/chainparams.cpp#L214).
