# Support for Output Descriptors in Panda3 Core

Since Panda3 Core v0.17, there is support for Output Descriptors. This is a
...
on Panda3's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Panda3 Core wallets, a convenience function `combo` is
